/*1712393215,,JIT Construction: v1012596422,vi_VN*/
...
try {
        ...
        for (var i = 0; i < sandboxSafelist.length; i++) {
            ...
            with(this) {
                ...
                __d("JSSDKRuntimeConfig", [], {
                    ...
                    "sdkab": null,
                    "sdkns": "",
                    "sdkurl": "https:\/\/connect.facebook.net\/vi_VN\/sdk\/xfbml.customerchat.js",
                ...
                __d("TimeSliceInteractionSV", [], {
                    ...
                    "also_record_new_timeslice_format": {
                        "thing": false
                    },
                    "force_async_request_tracing_on": {
                        "thing": false
                    }
                });
                    ...
                    var n = c("Type").extend({
                        ...
                        o = {
                            ...
                            _createMobileLoader: function() {
                                var a = document.createElement("div");
                                c("sdk.UA").nativeApp() ? a.innerHTML = '<div class="dialog_header"></div>' : o.isTabletStyle() ? a.innerHTML = '<div class="overlayLoader"><div id="fb_dialog_loader_spinner"></div><a id="fb_dialog_loader_close" href="#">' + c("sdk.fbt")._("H\u1ee7y") + "</a></div>" : a.innerHTML = '<div class="dialog_header"><table>  <tbody>    <tr>      <td class="header_left">        <label class="touchable_button">          <input type="submit" value="' + c("sdk.fbt")._("H\u1ee7y") + '"            id="fb_dialog_loader_close"/>        </label>      </td>      <td class="header_center">        <div>         ' + c("sdk.fbt")._("\u0110ang t\u1ea3i...") + '        </div>      </td>      <td class="header_right">      </td>    </tr>  </tbody></table></div>';
                                return o.create({
                    ...
                    a = function(a) {
                        ...
                        e.$ChatDOMFacade$p_18 = function(a) {
                            switch (a) {
                                ...
                                case "help":
                                    return c("sdk.fbt")._("Tr\u1ee3 gi\u00fap");
                                case "ask_us":
                                    return c("sdk.fbt")._("H\u1ecfi ch\u00fang t\u00f4i");
                                case "none":
                                    return ""
                            }
                        };
                ...
                __d("sdk.SharedStringConstants", ["sdk.fbt"], (function(a, b, c, d, e, f, g) {
                    "use strict";
                    b = {
                        continueWith: (a = c("sdk.fbt"))._("Ti\u1ebfp t\u1ee5c v\u1edbi {facebook_app_name} ho\u1eb7c {instagram_app_name}"),
                        continueWithShort: a._("{facebook_app_name} ho\u1eb7c {instagram_app_name}"),
                        loginButtonAriaLabel: a._("Ti\u1ebfp t\u1ee5c b\u1eb1ng Facebook ho\u1eb7c Instagram"),
                        logout: a._("\u0110\u0103ng xu\u1ea5t"),
                        logoutButtonAriaLabel: a._("\u0110\u0103ng xu\u1ea5t kh\u1ecfi trang web hi\u1ec7n t\u1ea1i"),
                        titleText: a._("Ch\u1ecdn t\u00e0i kho\u1ea3n"),
                        promptText: a._("B\u1ea1n mu\u1ed1n d\u00f9ng t\u00e0i kho\u1ea3n n\u00e0o \u0111\u1ec3 \u0111\u0103ng nh\u1eadp?"),
                        facebookText: a._("\u0110\u0103ng nh\u1eadp b\u1eb1ng Facebook"),
                        facebookTextShort: a._("Log in"),
                        instagramText: a._("\u0110\u0103ng nh\u1eadp b\u1eb1ng Instagram"),
                        disambiguationDialogAriaLabelText: a._("Log in with Facebook or Instagram"),
                        fbButtonText: a._("Ti\u1ebfp t\u1ee5c v\u1edbi Facebook"),
                        igButtonText: a._("Ti\u1ebfp t\u1ee5c b\u1eb1ng Instagram")
                    };
                ...
                __d("legacy:fb.xfbml.customerchat", ["FB", "XFBML", "sdk.XFBML.CustomerChatWrapper", "throttle"], (function(a, b, c, d, e, f, g) {
                    c("XFBML").registerTag({
                        xmlns: "fb",
                        localName: "customerchat",
                        ctor: d("sdk.XFBML.CustomerChatWrapper").CustomerChatWrapperPlugin
                    });
                    c("FB").provide("CustomerChat", {
                        show: (a = c("throttle"))(function(a) {
                            d("sdk.XFBML.CustomerChatWrapper").CustomerChatInternalEvent.inform(d("sdk.XFBML.CustomerChatWrapper").CustomerChatInternalEventType.SHOW, a)
                        }, 1e3),
                        hide: a(function() {
                            d("sdk.XFBML.CustomerChatWrapper").CustomerChatInternalEvent.inform(d("sdk.XFBML.CustomerChatWrapper").CustomerChatInternalEventType.HIDE)
                        }, 1e3),
                        showDialog: a(function() {
                            d("sdk.XFBML.CustomerChatWrapper").CustomerChatInternalEvent.inform(d("sdk.XFBML.CustomerChatWrapper").CustomerChatInternalEventType.SHOW_DIALOG)
                        }, 1e3),
                        hideDialog: a(function() {
                            d("sdk.XFBML.CustomerChatWrapper").CustomerChatInternalEvent.inform(d("sdk.XFBML.CustomerChatWrapper").CustomerChatInternalEventType.HIDE_DIALOG)
                        }, 1e3),
                        update: a(function(a) {
                            d("sdk.XFBML.CustomerChatWrapper").CustomerChatInternalEvent.inform(d("sdk.XFBML.CustomerChatWrapper").CustomerChatInternalEventType.UPDATE, a)
                        }, 1e3)
                    })
                }), 35);
            }
    ...
    i.src = 'https://www.facebook.com/platform/scribe_endpoint.php/?c=jssdk_error&m=' + encodeURIComponent('{"error":"LOAD", "extra": {"name":"' + e.name + '","line":"' + (e.lineNumber || e.line) + '","script":"' + (e.fileName || e.sourceURL || e.script || "xfbml.customerchat.js") + '","stack":"' + (e.stackTrace || e.stack) + '","revision":"1012596422","namespace":"FB","message":"' + e.message + '"}}');
