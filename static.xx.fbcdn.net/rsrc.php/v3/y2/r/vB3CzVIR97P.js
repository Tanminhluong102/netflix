...
__d("BigPipe", ["$", "Arbiter", "BigPipeExperiments", "BigPipeInstance", "BigPipePlugins", "Bootloader", "ErrorUtils", "FBLogger", "HasteResponse", "PageEvents", "PageletEventConstsJS", "PageletSet", "ServerJS", "TimeSlice", "TrustedTypesBigPipeMarkupPolicy", "TrustedTypesNoOpPolicy_DO_NOT_USE", "TrustedTypesUnsafeFunctionScriptPolicy_DO_NOT_USE", "UserTimingUtils", "captureUsageSnapshot", "clearTimeout", "cr:135", "fastDeepCopy", "ge", "performanceAbsoluteNow", "setTimeout"], (function(a, b, c, d, e, f, g) {
    ...
    e = function() {
        function a(e) {
            ...
            this.config.extra_dom_content_event != null && e.push(this.config.extra_dom_content_event);
        ...
        e._displayPagelet = function(a) {
            ...
            for (var f in a.content) {
                ...
                if (g) {
                    if (a.append) r(h, g, d);
                    else if (g.nodeType) h.innerHTML = c("TrustedTypesBigPipeMarkupPolicy").createHTML(""), r(h, g, d);
                    else {
                        i = p(g);
            ...
            if (a.static_templates) {
                ...
                g && (i = p(a.static_templates), a.replace_static_templates_if_exists && (i = s(g, i, d)), r(g, i, d))
            }
        ...
        e._nextPhase = function() {
            this.config.flush_pagelets_asap ? j <= 8 ? c("setTimeout")(this._tryRenderingNextPhase.bind(this), 20) : this._tryRenderingNextPhase() : (this._currentPhase++, j <= 8 ? c("setTimeout")(this._beginPhase.bind(this, this._currentPhase), 20) : this._beginPhase(this._currentPhase))
        };
        e._fireDisplayDone = function(a) {
            this._displayDoneFired = !0, this.arbiter.inform("display_done", !0), this._displayDone = !0, a(), this.lid != null && m("display_done", this.lid, "all")
        };
        e._downloadJsForPagelet = function(a) {
            ...
            c("Bootloader").loadResources(a.allResources || [], {
                onAll: function() {
                    ...
                    var d = function() {
                            b._informPageletEvent(c("PageletEventConstsJS").ONLOAD_START, a), b._isRelevantPagelet(a) && n(a.onload), b._informPageletEvent(c("PageletEventConstsJS").ONLOAD_END, a), b.arbiter.inform("pagelet_onload", !0), a.provides && b.arbiter.inform(a.provides, !0, "state")
                        },
                        e = function() {
                            b._isRelevantPagelet(a) && n(a.onafterload)
                        };
        ...
        e._informEventExternal = function(a, b, d) {
            b = b || {}, d = d || this.arbiter, b.ts || (b.ts = (h || (h = c("performanceAbsoluteNow")))()), k && (console.timeStamp && console.timeStamp(a + " " + (Object.prototype.hasOwnProperty.call(b, "arbiter") ? JSON.stringify(babelHelpers["extends"]({}, b, {
                arbiter: null
...
__d("hyperionCore", ["Promise", "__debug", "hyperionHook"], (function(a, b, c, d, e, f, g) {
    ...
    var G = function(b) {
        ...
        c.interceptProperty = function(a, b, c) {
            ...
            if (c)
                if (c.value) this.setOriginal(c.value), c.value = this.interceptor, q(c.container, this.name, c), this.status = 1;
                else if (c.get || c.set) {
                var f = this;
                d = c;
                var g = d.get,
    ...
    var M = function() {
        ...
        O = function() {
            if (typeof __webpack_module_cache__ === "object") return new pa(__webpack_module_cache__);
