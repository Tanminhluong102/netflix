...
__d("CometTailLoadLogger", ["QuickLogActionType", "QuickPerformanceLogger", "SiteData", "VisibilityListener", "gkx", "performanceNavigationStart", "qpl", "uuidv4"], (function(a, b, c, d, e, f, g) {
    "use strict";
    var h, i = 3e3,
        j = c("gkx")("1326"),
        k = 0,
    ...
    function a() {
        m.clear(), n.clear(), o.clear(), p.clear()
    }

    function s(a, b, d) {
        k++;
        j && (h || (h = c("QuickPerformanceLogger"))).markerStart(c("qpl")._(588713587, "4750"), k, d + l, {
            trackedForLoss: !0
        });
        d = a + "_" + b;
        o.set(d, k)
    ...
    function t(a, b, e, f, g) {
        var k = a + "_" + b,
            ...
            u = n.get(a) || e,
            v = m.get(k);
        v != null && (t = v, m["delete"](k));
        v = o.get(k);
        v == null && (s(a, b, u), v = o.get(k));
        u = d("VisibilityListener").getHiddenTime(u + c("performanceNavigationStart")(), e + c("performanceNavigationStart")());
        j && ((h || (h = c("QuickPerformanceLogger"))).markerAnnotate(c("qpl")._(588713587, "4750"), {
            "int": {
                client_revision: c("SiteData").client_revision,
                hidden: Number(u != null && u > 0),
                interruptedConsumption: t,
                position: b,
            ...
            instanceKey: v
        }), h.markerEnd(c("qpl")._(588713587, "4750"), f, v, e + l));
        if (f !== 2 || f === 706 && t >= i) {
            u = Object.keys(c("QuickLogActionType")).find(function(a) {
                return c("QuickLogActionType")[a] === f
            }) || "UNKNOWN";
            r.add({
                position: b,
                scrollingFNLType: u,
    ...
    g.alreadyFinishedMarkerKeys = p;
    g.reset = a;
    g.startTailLoadTracing = s;
    g.setTailLoadStartTime = b;
    g.reportInterruptedConsumption = e;
    g.endTailloadTracing = t;
    g.logMarkerEnd = f;
    g.dump = u
}), 98);
__d("CometRouterRouteTracePolicyContext", ["react"], (function(a, b, c, d, e, f, g) {
    "use strict";
    var h;
    a = h || d("react");
    b = a.createContext();
...
__d("FDSIcon.react", ["BaseImage_DEPRECATED.react", "BaseIsDecorativeContext", "CometPressable.react", "CometSVGIcon.react", "CometTintedIcon.react", "FlightSerializableIcon", "IconSource", "ImageIconSource", "SVGIcon", "TintableIconSource", "react", "stylex"], (function(a, b, c, d, e, f, g) {
    "use strict";
    ...
    function a(a, b) {
        ...
        var g = a.disabled;
        g = g === void 0 ? !1 : g;
        var i = a.disableOverlay_DEPRECATED;
        i = i === void 0 ? !1 : i;
        a.draggable;
        var n = a.focusable,
            o = a.hideHoverOverlay;
        o = o === void 0 ? !1 : o;
        var p = a.icon,
            q = a.id,
            r = a.isDecorative,
        ...
        A = A === void 0 ? !1 : A;
        var B = a.xstyle,
            C = babelHelpers.objectWithoutPropertiesLoose(a, ["alt", "color", "disabled", "disableOverlay_DEPRECATED", "draggable", "focusable", "hideHoverOverlay", "icon", "id", "isDecorative", "linkProps", "onHoverIn", "onHoverOut", "onPress", "onPressIn", "onPressOut", "size", "testid", "testOnly_pressed", "xstyle"]);
        p = d("FlightSerializableIcon").parseFlightIcon(p);
        z = v == null ? z : void 0;
        e = a.disabled === !0 ? "disabled" : e;
        var D = v != null || r != null,
            E = k(function() {
                if (!D && C["aria-label"] != null) return C["aria-label"];
                return s ? "" : f
            }, [C, s, D, f]),
            F = D ? void 0 : b;
        B = p instanceof c("TintableIconSource") ? j.jsx(c("CometTintedIcon.react"), {
            alt: E,
            color: m(e),
            ...
            testid: void 0,
            xstyle: B
        }) : p instanceof c("ImageIconSource") ? j.jsx(c("BaseImage_DEPRECATED.react"), {
            alt: E,
            className: (h || (h = c("stylex")))(l.image, p.resizeStrategy === "contain" && l.imageContain, p.resizeStrategy === "cover" && l.imageCover, B),
            draggable: a.draggable,
            id: q,
            ref: F,
            src: p.src,
            ...
            testid: void 0
        }) : p instanceof c("IconSource") ? j.jsx(c("BaseImage_DEPRECATED.react"), {
            alt: E,
            className: (h || (h = c("stylex")))(l.image, B),
            draggable: a.draggable,
            height: p.size,
            id: q,
            ref: F,
            src: p.src,
            width: p.size
        }) : p instanceof d("SVGIcon").LegacySVGIcon ? j.createElement(p.component, {
            alt: E,
            color: e,
            "data-testid": z,
            id: q,
            size: y
        }) : p instanceof d("SVGIcon").SVGIcon ? j.jsx(c("CometSVGIcon.react"), {
            alt: E,
            color: e,
            ...
            id: q,
            size: y
        }) : p instanceof d("SVGIcon").EmojiIcon ? j.createElement(p.component, {
            emoji: p.codepoints,
            size: y
        }) : j.jsx(c("CometSVGIcon.react"), {
            alt: E,
            color: e,
            component: p,
            "data-testid": void 0,
        ...
        a = s ? j.jsx(c("BaseIsDecorativeContext").Provider, {
            value: !0,
            children: B
        }) : B;
        return D ? j.jsx(c("CometPressable.react"), babelHelpers["extends"]({}, C, {
            disabled: g,
            focusable: n,
            hideHoverOverlay: o,
            linkProps: r,
