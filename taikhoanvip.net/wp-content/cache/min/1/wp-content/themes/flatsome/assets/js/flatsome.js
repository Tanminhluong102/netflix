    ...
    r.m = i, t = Object.getPrototypeOf ? function(e) {
        ...
        function() {
            ...
            function E(e) {
                ! function(e) {
                    let {
                        element: t,
                        type: n
                    } = e, o = I(t.dataset.parallax), i = L(t), a = (window.innerHeight - i.offsetHeight) * o;
                    switch (n) {
                ...
                function(e) {
                    let {
                        element: t,
                        type: n
                    } = e, o = I(t.dataset.parallax || t.dataset.parallaxBackground), i = window.innerHeight, a = L(t), r = t.offsetHeight - a.offsetHeight, s = t.getBoundingClientRect(), l = a !== t ? a.getBoundingClientRect() : s, c = s.top + t.offsetHeight / 2, u = i / 2 - c, d = i / 2 - (l.top + a.offsetHeight / 2), h = c + T() < i / 2 ? T() : u, f = (Math.abs(u), Math.abs(h) / (i / 2)), p = 0;
                    var y;
            ...
            function $(e) {
                e.each(((e, t) => {
                    const n = jQuery(t);
                    n.hasClass("current-dropdown") && D(n)
                }))
            }
            ...
            Flatsome.behavior("count-up", {
                ...
                attach(e) {
                    ...
                    jQuery(".header-nav > li > a, .top-bar-nav > li > a", e).on("focus", (() => {
                        ...
                        l.on("touchstart click", (function(e) {
                            ...
                            if (e.preventDefault(), r = l, l.hasClass("current-dropdown")) return D(l), void H(o, "click");
                            $(t), S(l), z(o, "click"), jQuery(document).trigger("flatsome-dropdown-opened", [l])
                        }))) : (l.on("keydown", "a:first", (function(e) {
                            "Space" === e.code && (e.preventDefault(), l.hasClass("current-dropdown") ? (D(l), H(o, "click")) : ($(t), S(l), z(o, "click"), jQuery(document).trigger("flatsome-dropdown-opened", [l])))
                        })), l.hoverIntent({
                            sensitivity: 3,
                            interval: 20,
                            timeout: 70,
                            over(e) {
                                $(t), S(l), H(o, "click"), jQuery(document).trigger("flatsome-dropdown-opened", [l])
                            },
                            out() {
                                d = !1, u = !1, D(l)
                            }
                        ...
                        null === r || r === e.target || r.has(e.target).length || (D(r), H(o, "click"))
                ...
                attach(e) {
                    jQuery(".tooltip:not(.hotspot), .has-tooltip, .tip-top, li.chosen a", e).lazyTooltipster(), jQuery(".tooltip-as-html", e).lazyTooltipster({
                        interactive: !0,
                        contentAsHTML: !0
                    }), /Android|webOS|iPhone|iPad|iPod|BlackBerry/i.test(navigator.userAgent) ? jQuery(".hotspot.tooltip:not(.quick-view)", e).lazyTooltipster({
                        trigger: "click"
