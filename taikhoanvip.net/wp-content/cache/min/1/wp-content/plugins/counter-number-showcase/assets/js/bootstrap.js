...
(function(global, factory) {
    ...
    const executeAfterTransition = (callback, transitionElement, waitForTransition = !0) => {
    ...
    const EventHandler = {
        ...
        trigger(element, event, args) {
            ...
            if (isNative) {
                ...
                evt.initEvent(typeEvent, bubbles, !0)
            } else {
        ...
        hide() {
            ...
            for (let i = 0; i < triggerArrayLength; i++) {
                ...
                if (elem && !this._isShown(elem)) {
                    this._addAriaAndCollapsedClass([trigger], !1)
                }
            }
            this._isTransitioning = !0;
            const complete = () => {
    ...
    class Dropdown extends BaseComponent {
        ...
        _createPopper(parent) {
            ...
            const isDisplayStatic = popperConfig.modifiers.find(modifier => modifier.name === 'applyStyles' && modifier.enabled === !1);
        ...
        static clearMenus(event) {
            ...
            for (let i = 0, len = toggles.length; i < len; i++) {
                ...
                if (!context || context._config.autoClose === !1) {
                    continue
                }
                if (!context._isShown()) {
                    continue
    ...
    class Tooltip extends BaseComponent {
        ...
        _getConfig(config) {
            ...
            config.container = config.container === !1 ? document.body : getElement(config.container);
    ...
    class Tab extends BaseComponent {
        ...
        _activate(element, container, callback) {
            ...
            if (active && isTransitioning) {
                ...
                this._queueCallback(complete, element, !0)
            } else {
                complete()
            }
        }
