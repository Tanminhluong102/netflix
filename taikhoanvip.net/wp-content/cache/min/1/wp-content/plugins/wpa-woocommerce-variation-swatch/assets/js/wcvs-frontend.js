(function($, window, document, undefined) {
    ...
    function wpa_wcvs_update_images() {
        ...
        var selected = [];
        $('body').on('click touchstart', '.swatch__list--item', function(e) {
...
(function($) {
    ...
    var nl_update_price = function() {
        ...
        if ($('.variations_form').length > 0) {
            ...
            if (variation_price) {
                $('.entry-summary p.price').html(variation_price)
            }
            $('.swatch__list').click(function() {
                setTimeout(function() {
                    variation_price2 = $('.woocommerce-variation-price .price').html();
                    $('.entry-summary p.price').html(variation_price2)
                }, 50)
            })
        }
    }
