    ...
    var l = function() {
                ...
                o = function(n) {
                    ...
                    if (void 0 !== c) {
                        ...
                        r.headings.removeClass("ftwp-heading-target"), $targetObj.attr("id", "").addClass("ftwp-heading-target"), window.location.hash = i, $targetObj.attr("id", d), t("html, body").animate({
                            ...
                            }), s(n), r.container.trigger("ftocAfterScrollToTarget", [n, f])
                        })
                    }
                },
                s = function(t) {
                    if (d(), n = t, t.addClass("ftwp-active"), (u.location.fixedToPost || u.location.fixedWidget) && (t.is(":focus") || e || t.focus()), f.showColExpIcon()) {
                        var i = t.prev();
            ...
            return {
                _construct: function() {
                    r.anchors.on("click", function(n) {
                        ...
                        o(e)
                    }), r.anchors.on("mousedown", i), c("Actived scrollToTarget().")
                },
                activeCurrent: s,
        ...
        h = function() {
            var n, e, i = function() {
                function i() {
                    t.each(o, function(t) {
                        return void 0 === o[t + 1] && this.headingTop <= a.data.ftocRangeY.bottom ? (n = [this, o[t], t], e = a.data.document.height, l.activeCurrent(this.anchorEle), r.container.trigger("ftocAfterTargetIndicated", [this.anchorEle, s]), !1) : this.headingTop <= s && o[t + 1].headingTop > s ? (n = [this, o[t + 1], t], e = a.data.document.height, l.activeCurrent(this.anchorEle), r.container.trigger("ftocAfterTargetIndicated", [this.anchorEle, s]), !1) : void 0
                    })
                }
                var o = a.data.headingsTop,
                    s = a.data.scrollTop;
                return o[0].headingTop > s || a.data.ftocRangeY.bottom < s ? (void 0 !== n && l.deactiveAll(), void(n = void 0)) : void 0 !== e && e != a.data.document.height ? (i(), void c("Fixed target indicator!!")) : void(void 0 !== n && n[0].headingTop <= s && n[1].headingTop > s || i())
            };
            return {
                _construct: function() {
